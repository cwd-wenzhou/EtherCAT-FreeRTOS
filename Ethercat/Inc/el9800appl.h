 ...
 * @{
 */
/** \brief 0x1601 (AD_Switch_Cmd output RxPDO) data structure*/
...
/** \brief 0x1602 (DIANCIFA_cmd output RxPDO) data structure*/   
//2020.8.6添加
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[9]; /**< \brief Entry buffer*/
...
/** \brief 0x1A01 (AD_Switch_Status TxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[9]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
...
/** \brief 0x1A03 (diancifa_Status TxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[9]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
...
/** \brief 0x1A04 (Self_Check_Status TxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[9]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
...
/** \brief 0x6030 (Diancifa_Check input object) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   BOOLEAN(diancifa1_STATE); /**< \brief diancifa1_STATE */
   BOOLEAN(diancifa2_STATE); /**< \brief diancifa2_STATE */
   BOOLEAN(diancifa3_STATE); /**< \brief diancifa3_STATE */
   BOOLEAN(diancifa4_STATE); /**< \brief diancifa4_STATE */
	 UINT16(diancifa1_Time); /**< \brief diancifa1_Time*/
   UINT16(diancifa2_Time); /**< \brief diancifa2_Time*/
   UINT16(diancifa3_Time); /**< \brief diancifa3_Time*/
   UINT16(diancifa4_Time); /**< \brief diancifa4_Time*/
   ALIGN12(SubIndex12) /**< \brief 12Bit alignment*/
} OBJ_STRUCT_PACKED_END
TOBJ6030;

/** \brief 0x6040 (Self_Check input object) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
...
PROTO TOBJ1602 DIANCIFA_cmd
#ifdef _EVALBOARD_
 = {9, {0x70120101, 0x70120201, 0x70120301, 0x70120401,0x0c,0x70120510, 0x70120610, 0x70120710, 0x70120810}}
#endif
;
//添加于2020.12.25
...
/**
 *
 * \brief Object 0x1A03(diancifa_Check_Status input TxPDO) entry descriptions
 */
PROTO TOBJ1A03 Diancifa_STATUS_1A03
#ifdef _EVALBOARD_
= {9, {0x60300101, 0x60300201, 0x60300301, 0x60300401,0x0c,0x60300510, 0x60300610, 0x60300710, 0x60300810}}
#endif
;
/**修改于2020.12.29@}*/
...
/**
 * \brief Object 0x1A04 (自检状态 input TxPDO) entry descriptions
 *修改于2021.3.8
 * SubIndex 0 : read only<br>
 * SubIndex x : read only<br>
 *  (x > 0)
...
/**
 * \brief Object 0x1A04 (Self_Check_Status input TxPDO) entry descriptions
 *
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
OBJCONST UCHAR OBJMEM aName0x1A04[] = "AI TxPDO-Map\000\377";
#endif //#ifdef _OBJD_
 ...
 * \brief Object 0x1A04(Self_Check_Status input TxPDO) entry descriptions
 */
PROTO TOBJ1A04 Selfcheck_STATUS_1A04
#ifdef _EVALBOARD_
= {9, {0x60400101, 0x60400201, 0x60400301, 0x60400401,0x60400501, 0x60400601, 0x60400701, 0x60400801,0x08}}
#endif
;
/**修改于2021.3.8@}*/
...
#ifdef _EVALBOARD_
= {0x05, {0x1A00,0x1A01,0x1A03,0x1A04,0x1A05}}
#endif
;
/** @}*/
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6030[] = {
   {DEFTYPE_BOOLEAN, 0x01, ACCESS_READ | OBJACCESS_RXPDOMAPPING}, /* SubIndex 001: diancifa1_state */
   {DEFTYPE_BOOLEAN, 0x01, ACCESS_READ | OBJACCESS_RXPDOMAPPING}, /* SubIndex 002: diancifa1_state */
   {DEFTYPE_BOOLEAN, 0x01, ACCESS_READ | OBJACCESS_RXPDOMAPPING}, /* SubIndex 003: diancifa1_state */
   {DEFTYPE_BOOLEAN, 0x01, ACCESS_READ | OBJACCESS_RXPDOMAPPING}, /* SubIndex 004: diancifa1_state */
	 {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING}, /* SubIndex 005: diancifa1_time */
   {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING}, /* SubIndex 006: diancifa2_time */
   {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING}, /* SubIndex 007: diancifa3_time */
   {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING}, /* SubIndex 008: diancifa4_time */
	 {0x0000, 0x12, 0}
	 };
 ...
 * \brief Object 0x6030 (SELF_CHECK_STATUS input object) entry descriptions
 */
OBJCONST UCHAR OBJMEM aName0x6030[] = "Diancifa_states_Inputs Outputs\000CH1_state 1\000CH2_state 2\000CH3_state 3\000diancifa1_time 4\000diancifa2_time 5\000diancifa3_time 6\000diancifa4_time 7\000CH4_Frequency 8\000\000\377";
#endif //#ifdef _OBJD_
 ...
 * 
 */
PROTO TOBJ6030 Diancifa_STATUS_6030
#ifdef _EVALBOARD_
...
#ifdef _OBJD_
/**
 * \brief Object 0x6040 (SELF_CHECK_STATUS input object)entry descriptions
**/
 ...
 * \brief Object 0x6040 (SELF_CHECK_STATUS input object) entry descriptions
 */
OBJCONST UCHAR OBJMEM aName0x6040[] = "Diancifa_states_Inputs Outputs\000CH1_state 1\000CH2_state 2\000CH3_state 3\000CH4_state 4\000software_state 5\000hardware_state 6\000EtherCAT_state 7\000ALL_state 8\000\000\377";
#endif //#ifdef _OBJD_



/**
 * \brief 0x6040 (SELF_CHECK_STATUS input object) variable to handle object data
 * 
 */
PROTO TOBJ6040 Selfcheck_STATUS_6040
#ifdef _EVALBOARD_
...
= {8,"ECMK-B", "V1.0", "V1.0", 0x04,0x11111111,0x01,0x01,0x01}
#endif
;
...
TOBJECT    OBJMEM ApplicationObjDic[] = {
   ...
   {NULL,NULL,  0x1601, {DEFTYPE_PDOMAPPING, 9 | (OBJCODE_REC << 8)}, asEntryDesc0x1601, aName0x1601, &AD_Switch_Cmd_IN, NULL, NULL, 0x0000 },
	 ...
	 {NULL,NULL,  0x1602, {DEFTYPE_PDOMAPPING, 9 | (OBJCODE_REC << 8)}, asEntryDesc0x1602, aName0x1602, &DIANCIFA_cmd, NULL, NULL, 0x0000 },	 
   /* Object 0x1802 */
   ...
   {NULL,NULL,   0x1A02, {DEFTYPE_PDOMAPPING, 8 | (OBJCODE_REC << 8)}, asEntryDesc0x1A02, aName0x1A02, &sAITxPDOMap, NULL, NULL, 0x0000 },
	 /* Object 0x1A03 */
   {NULL,NULL,   0x1A03, {DEFTYPE_PDOMAPPING, 9 | (OBJCODE_REC << 8)}, asEntryDesc0x1A03, aName0x1A03, &Diancifa_STATUS_1A03, NULL, NULL, 0x0000 },
	 /* Object 0x1A04 */
   {NULL,NULL,   0x1A04, {DEFTYPE_PDOMAPPING, 9 | (OBJCODE_REC << 8)}, asEntryDesc0x1A04, aName0x1A04, &Selfcheck_STATUS_1A04, NULL, NULL, 0x0000 },
	 /* Object 0x1A05 */
  ...
  // {NULL,NULL,   0x6020, {DEFTYPE_RECORD, 17 | (OBJCODE_REC << 8)}, asEntryDesc0x6020, aName0x6020, &Current_Inputs, NULL, NULL, 0x0000 },
	 /* Object 0x6030 */
   {NULL,NULL,   0x6030, {DEFTYPE_RECORD, 8 | (OBJCODE_REC << 8)}, asEntryDesc0x6030, aName0x6030, &Diancifa_STATUS_6030, NULL, NULL, 0x0000 },
	    /* Object 0x6040 */
   {NULL,NULL,   0x6040, {DEFTYPE_RECORD, 8 | (OBJCODE_REC << 8)}, asEntryDesc0x6040, aName0x6040, &Selfcheck_STATUS_6040, NULL, NULL, 0x0000 },
	 	    /* Object 0x6050 */
